...
const About = () => {
  return (
    <div className='relative about bg-rose-50/20'>
        <div className='sm:grid grid-cols-4  mx-auto sm:px-10 sm:py-10'>
            ...
            <div className='col-span-1'>
                <div className='flex flex-col justify-center items-center sm:mt-14 sm:-ml-20'>
                    <h1 className='text-2xl font-bold font-playfair mt-5 text-rose-600 uppercase'>About Us</h1>
                    <p className='text-gray-800 ml-5 text-1xl mt-3 leading-10'>
