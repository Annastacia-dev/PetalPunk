...
const About = () => {
  return (
    <div className='relative about bg-rose-50/20' id='about'>
        <div className='sm:grid grid-cols-3  mx-auto sm:px-10 sm:py-10'>
            ...
            <div className='col-span-1'>
                <div className='flex flex-col justify-center items-center sm:mt-14 sm:-ml-2'>
                    <h1 className='text-3xl font-bold font-playfair mt-5 text-rose-600 tracking-widest uppercase'>About Us</h1>
