  ...
  return (
    <div className="h-full">
            <div className="relative bg-rose-50 h-96">
                <div className="top-0 absolute left-6 h-full border-rose-600 border-r-2">
                    ...
                    <div className="flex justify-center">
                        <div className="bg-white max-w-sm">
                            <a href="/flowers" data-mdb-ripple="true" data-mdb-ripple-color="light"> 
                                ...
                                <h5 className="text-gray-900 text-xl font-medium mb-2 p-6">Flowers &rarr;</h5>
                            </a>
                        </div>
                    </div>
                    <div className="flex justify-center">
                        <div className="bg-white max-w-sm">
                            <a href="/plants" data-mdb-ripple="true" data-mdb-ripple-color="light">
                                ...
                                width={300} height={300} alt=""/>
                                <h5 className="text-gray-900 text-xl font-medium mb-2 p-6">Plants &rarr;</h5>
                            </a>
                        </div>
                    </div>
                    <div className="flex justify-center">
                        <div className="bg-white max-w-sm">
                            <a href="/gifts" data-mdb-ripple="true" data-mdb-ripple-color="light">
                                ...
                                width={300} height={300} alt=""/>
                                <h5 className="text-gray-900 text-xl font-medium mb-2 p-6">Gifts &rarr;</h5>
                            </a>
                        </div>
                    </div>            
                </div>
